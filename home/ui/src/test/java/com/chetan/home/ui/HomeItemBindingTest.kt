...
//
//        // WHEN
//        bind { this.viewState = state }
//
//        // THEN
//        assertThat(titleTextView, withText(state.homeListItem.title))
//        assertThat(descriptionTextView, withText(state.homeListItem.description))
//        assertThat(storyCardView.cardBackgroundColor, equalTo(valueOf(state.palette.primary)))
//    }
//
//
//
